      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-[10px] uppercase font-bold tracking-[0.3em] text-white/50">Testimonios</span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6 items-stretch mb-6">
          ...
          <div className="glass-card rounded-[40px] p-10 md:p-14 flex flex-col justify-center border-white/10 relative overflow-hidden bg-white/[0.01]">
            <p className="text-2xl md:text-3xl font-medium tracking-tight text-white/90 leading-snug mb-10 relative z-10">
              "La capacidad de NextWave para entender nuestra visión y transformarla en una plataforma de ventas masivas fue impresionante."
            </p>
            <div>
              <div className="text-lg font-bold text-white uppercase tracking-tight">Tom Sullivan</div>
              <div className="text-[10px] font-bold text-white/30 uppercase tracking-[0.2em]">Director Estratégico, Nova Agency</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {secondaryTestimonials.map((item, idx) => (
            <div key={idx} className="glass-card rounded-[32px] p-8 border-white/10 flex flex-col justify-between bg-white/[0.01] group hover:bg-white/[0.03] transition-all duration-300">
              <p className="text-white/60 text-sm leading-relaxed mb-8 flex-1 italic group-hover:text-white/80 transition-colors">"{item.text}"</p>
              <div className="flex items-center gap-4 pt-6 border-t border-white/5">
                ...
                <div>
                  ...
                  <div className="text-[9px] text-white/40 tracking-widest uppercase font-bold">{item.role}</div>
                </div>
              </div>
            </div>
          ))}
