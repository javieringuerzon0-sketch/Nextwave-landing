...
const PlanesPage = () => {
  ...
  return (
    <>
      <SEO
        title="Planes y Servicios - NextWave IA | Desarrollo Web, Apps y Marketing"
        description="Descubre nuestros planes de desarrollo web profesional, aplicaciones móviles y servicios de marketing digital. Desde $5,550 MXN. Soluciones personalizadas con IA."
        url="https://nextwave-ia-landing.vercel.app/planes"
        keywords="planes desarrollo web, precios páginas web, aplicaciones móviles México, marketing digital, servicios web IA"
      />
