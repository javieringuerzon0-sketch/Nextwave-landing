    ...
    >
      <nav className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            href="#contact"
            className="group relative inline-flex items-center justify-center px-6 py-2 text-xs font-bold uppercase tracking-widest text-black bg-white rounded-full hover:scale-105 transition-all duration-300"
          >
            Agenda una Demo
          </a>
        </div>
